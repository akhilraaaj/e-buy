...
import { usePaneLayout, usePane, PaneContent, PaneHeader, BackLink, PaneHeaderActions, Pane, _DEBUG } from './desk-d1f85929.js';
import { Delay, useDeskTool, useDeskToolSetting } from './index-6c71f0c1.js';
...
import { PaneItem } from './PaneItem-5ece3d70.js';
...
const addSelectedStateToMenuItems = options => {
  ...
  return menuItems == null ? void 0 : menuItems.map(item => {
    ...
    if ((_e = item == null ? void 0 : item.params) == null ? void 0 : _e.by) {
      return {
        ...item,
        selected: isEqual(sortOrder == null ? void 0 : sortOrder.by, ((_f = item == null ? void 0 : item.params) == null ? void 0 : _f.by) || EMPTY_ARRAY)
      };
    }
    return {
      ...item,
...
//# sourceMappingURL=index-706f5feb.js.map
