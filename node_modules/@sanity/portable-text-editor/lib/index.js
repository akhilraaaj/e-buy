...
var debug__default = /*#__PURE__*/_interopDefaultCompat(debug$m);
...
function isEqualToEmptyEditor(children, types) {
  var _a;
  return children === void 0 || children && Array.isArray(children) && children.length === 0 || children && Array.isArray(children) && children.length === 1 && slate.Element.isElement(children[0]) && children[0]._type === types.block.name && "style" in children[0] && children[0].style === types.styles[0].value && !("listItem" in children[0]) && Array.isArray(children[0].children) && children[0].children.length === 1 && slate.Text.isText(children[0].children[0]) && children[0].children[0]._type === "span" && !((_a = children[0].children[0].marks) == null ? void 0 : _a.join("")) && children[0].children[0].text === "";
}
...
function SlateContainer(props) {
  ...
  const initialValue = React.useMemo(() => value ? toSlateValue(value, {
...
function useSyncValue(props) {
  ...
  return React.useMemo(() => (value, userCallbackFn) => {
    const callbackFn = () => {
        ...
        withoutPatching(slateEditor, () => {
          slate.Editor.withoutNormalizing(slateEditor, () => {
            ...
            slateValueFromProps.forEach((c, i) => {
              ...
              if (oldBlock && !isEqual__default.default(c, oldBlock)) {
                ...
                withPreserveKeys(slateEditor, () => {
                  slate.Transforms.insertNodes(slateEditor, c, {
                    at: [i]
                  });
                });
                if (currentSel) {
                  slate.Transforms.select(slateEditor, currentSel);
                }
              }
              if (!oldBlock) {
...
function Validator(props) {
  ...
  const previousValue = React.useRef();
  const [invalidValueResolution, setInvalidValueResolution] = React.useState(null);
  React.useEffect(() => {
...
class PortableTextEditor extends React__default.default.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */jsxRuntime.jsx(Validator, {
      portableTextEditor: this,
      keyGenerator,
      value,
      children: /* @__PURE__ */jsxRuntime.jsx(SlateContainer, {
        keyGenerator,
        maxBlocks,
        patches$: _patches$,
        portableTextEditor: this,
