...
var getStudioEnvironmentVariables = require('./getStudioEnvironmentVariables-c1bb47cf.js');
...
async function getViteConfig(options) {
  ...
  const faviconsPath = path__default.default.join(path__default.default.dirname(sanityPkgPath), "static", "favicons");
  ...
  const viteConfig = {
    ...
    define: {
      ...
      ...getStudioEnvironmentVariables.getStudioEnvironmentVariables({
        prefix: "process.env.",
        jsonEncode: true
      })
    }
...
//# sourceMappingURL=runtime-755d7bc5.js.map
