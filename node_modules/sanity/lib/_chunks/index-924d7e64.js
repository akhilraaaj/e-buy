...
var desk = require('./desk-8d0c3cba.js');
var index = require('./index-e9a7e226.js');
var PathUtils = require('@sanity/util/paths');
var types = require('@sanity/types');
var sanity = require('sanity');
var PaneItem = require('./PaneItem-60490cdd.js');
...
const addSelectedStateToMenuItems = options => {
  ...
  return menuItems == null ? void 0 : menuItems.map(item => {
    ...
    if ((_e = item == null ? void 0 : item.params) == null ? void 0 : _e.by) {
      return {
        ...item,
        selected: isEqual__default.default(sortOrder == null ? void 0 : sortOrder.by, ((_f = item == null ? void 0 : item.params) == null ? void 0 : _f.by) || EMPTY_ARRAY)
      };
    }
    return {
      ...item,
...
//# sourceMappingURL=index-924d7e64.js.map
